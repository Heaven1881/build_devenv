...
curl -Lo "${BUILD_DIR}/download/jemalloc-${JEMALLOC_VERSION}.tar.bz2" "https://github.com/jemalloc/jemalloc/releases/download/${JEMALLOC_VERSION}/jemalloc-${JEMALLOC_VERSION}.tar.bz2" 1>&/dev/null
if [ $? -eq 0 ]; then
